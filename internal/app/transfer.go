...
func UploadPath(ctx context.Context, rc RepoContext, params TransferParams, localPath, remotePath string) error {
...
func DownloadPath(ctx context.Context, rc RepoContext, params TransferParams, remotePath, localPath string) error {
	if cfg, _, err := LoadConfig(rc.RepoRoot); err == nil && cfg != nil && cfg.Microsandbox != nil {
